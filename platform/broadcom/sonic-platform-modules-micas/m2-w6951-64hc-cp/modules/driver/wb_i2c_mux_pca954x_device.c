...
static i2c_mux_pca954x_device_t i2c_mux_pca954x_device_data0 = {
    ...
    .pca9548_base_nr                = 2,
    .pca9548_reset_type             = PCA9548_RESET_I2C,
    .rst_delay_b                    = 0,
    .rst_delay                      = 1000,
    .rst_delay_a                    = 1000,
    .attr = {
        .i2c_attr.i2c_bus           = 1,
        .i2c_attr.i2c_addr          = 0x0d,
        .i2c_attr.reg_offset        = 0x74,
        .i2c_attr.mask              = 0xFF,
        .i2c_attr.reset_on          = 0x8A,
        .i2c_attr.reset_off         = 0x8B,
    },
};
...
static i2c_mux_pca954x_device_t i2c_mux_pca954x_device_data1 = {
    ...
    .rst_delay_a                    = 1000,
    .attr = {
        .i2c_attr.i2c_bus           = 107,
        .i2c_attr.i2c_addr          = 0x2d,
        .i2c_attr.reg_offset        = 0xd4,
        .i2c_attr.mask              = 0xFF,
        .i2c_attr.reset_on          = 0x2A,
        .i2c_attr.reset_off         = 0x2B,
    },
};
